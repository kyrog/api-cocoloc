 ...
 */
final class Version20220629140702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE actions (id INT AUTO_INCREMENT NOT NULL, id_categories_id INT NOT NULL, is_incoming TINYINT(1) NOT NULL, title VARCHAR(50) NOT NULL, amount INT NOT NULL, INDEX IDX_548F1EF1C3AC5D2 (id_categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
